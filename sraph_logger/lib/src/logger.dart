...
class Logger {
  ...
  /// handled.
  void debug(Object? message, [Object? error, StackTrace? stackTrace]) => log(Level.DEBUG, message, error, stackTrace);
  ...
  /// See [log] for information on how non-String [message] arguments are
  /// handled.
  void error(Object? message, [Object? error, StackTrace? stackTrace]) => log(Level.ERROR, message, error, stackTrace);
