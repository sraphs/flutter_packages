...
import 'package:sraph_cache/src/adapters/datetime_adapter.dart';
...
void main() {
  group('DateTimeAdapter', () {
    ...
    test('can persist date times properly', () {
      ...
      final String value = verify(preferences.setString('key', captureAny)).captured.single;
    ...
    test('can revive date times properly', () {
      ...
      expect(
        storedDateTime.difference(dateTime) < const Duration(hours: 1, minutes: 1),
        isTrue,
      );
    });

    test('handles retrieving null datetime gracefully', () {
